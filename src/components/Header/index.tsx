      ...
      <nav className="py-0 py-md-4 px-md-5 flex-column navbar navbar-expand-md navbar-light fixed-top">
        <div className="container-fluid nav-container">
          <div className="w-100 d-flex align-items-center justify-content-between">
            <a
              href="/"
              className="d-flex flex-shrink-1 justify-content-start align-items-center me-0 py-0 navbar-brand afforai"
            >
              <img
                src={LogoNewViolet}
                alt="Afforai Logo"
            ...
            <div className="d-flex flex-row justify-content-end align-items-center gap-2 navbar-nav button-flex">
              <button
                type="button"
                className=" new-btn gray px-2 px-md-3 btn btn-primary fit-content"
              >
                Log in
              </button>
              <button
                type="button"
                className="new-btn violet-fill px-2 px-md-3 btn btn-primary try-free fit-content"
              >
                Try for free
              </button>
          ...
          <div className="d-none justify-content-start align-items-start navbar-nav">
            <a
              ...
              target="_blank"
              data-rr-ui-event-key="https://afforai.getrewardful.com/signup"
              className="mx-2 nav-link"
            >
              <span className="menu">Affiliate</span>
            </a>
            ...
            <a
              ...
              target="_blank"
              data-rr-ui-event-key="https://help.afforai.com/"
              className="mx-2 nav-link"
            >
              <span className="menu">Help Center</span>
            </a>
